              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                      ...
                      placeholder="Enter Category Discount" value="{{ !empty($category->id) ? $category->category_discount : old('category_discount')}}">
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                      <label>Category Description</label>
                      <textarea class="form-control" rows="3" name="description" id="description" 
                      placeholder="Enter Description" value="{{ !empty($category->id) ? $category->description : old('description')}}"></textarea>
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6">
                  ...
                  <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="meta_title" id="meta_title" placeholder="Enter Meta Title"
                      value="{{ !empty($category->id) ? $category->meta_title : old('meta_title')}}"></textarea>
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                      ...
                      placeholder="Enter Description..." value="{{ !empty($category->id) ? $category->meta_description : old('meta_description')}}"></textarea>
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                      ...
                      placeholder="Enter Keywords..." value="{{ !empty($category->id) ? $category->meta_keywords : old('meta_keywords')}}"></textarea>
                  </div>
                  <!-- /.form-group -->
                </div>
