		...
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="item active">
					<div class="container">
						<a href="#"><img style="width:100%" src="{{ asset('images/front/carousel/1.png') }}" alt="special offers"/></a>
				...
				<div class="item">
					<div class="container">
						<a href="register.html"><img style="width:100%" src="{{ asset('images/front/carousel/2.png') }}" alt=""/></a>
						<div class="carousel-caption">
				...
				<div class="item">
					<div class="container">
						<a href="register.html"><img src="{{ asset('images/front/carousel/3.png') }}" alt=""/></a>
						<div class="carousel-caption">
